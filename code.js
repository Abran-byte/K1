...
nextButton.addEventListener("click", ()=>{
    ...
    switch(phase) {
        case 1:
            ...
            break;
        case 2:
            text.innerText = 'II. Distance\nDistance measures how much the point moves. Think of it as how much steps the point took. A common symbol to represent distance is "d". Use the "Start" and "End" buttons to measure the distance traveled by the point.';
